...
- [3. 字根編碼](#3-字根編碼)
  - [3.1. 大碼和小碼](#31-大碼和小碼)
  - [3.2. 字根圖](#32-字根圖)
  - [3.3. 字根大碼的分佈規律](#33-字根大碼的分佈規律)
  - [3.4. 字根小碼的分佈規律](#34-字根小碼的分佈規律)
- [4. 拆字規則](#4-拆字規則)
  - [4.1. 獨體字的拆分](#41-獨體字的拆分)
  - [4.2. 規則優先級](#42-規則優先級)
  - [4.3. 拆字舉例](#43-拆字舉例)
- [5. 單字編碼規則](#5-單字編碼規則)
  - [5.1. 字根字](#51-字根字)
...
![成语古诗](/resources/徐码字根图2022316.jpg)
...
- 「好」字拆成```女子```，只有兩根，所以取全部根是，也就是```女Cv 子Bz```的大碼，即```CB```。此時，注意到不足四碼，故而補上最末根的小碼```z```。輸入```CBz```即可出字。
