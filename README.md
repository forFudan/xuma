...
- [3. 方案特点](#3-方案特点)
  ...
  - [3.2. 词语简码调整](#32-词语简码调整)
  - [3.3. 标点符号二简快速输入](#33-标点符号二简快速输入)
  - [3.4. 增广常用字符集](#34-增广常用字符集)
  - [3.5. 一键切换字符集](#35-一键切换字符集)
  - [3.6. 使用 / 键引导四叶草拼音输入和反查](#36-使用--键引导四叶草拼音输入和反查)
  - [3.7. 实时显示全简码](#37-实时显示全简码)
  - [3.8. 全码后置](#38-全码后置)
...
[點擊此處閱讀我所寫的《徐碼繁簡通打輸入法（爾雅輸入法）簡明教程》來瞭解和學習徐碼。](tutorial.md)
