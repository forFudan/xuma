...
注：[宇浩繁简通用输入法](https://zhuyuhao.com/yuhao)是我在使用徐码写了一百万字小说后开发的输入法。它继承了徐码繁简通打的优点，同时吸收五笔字形字根排布直观、规则简单的优点，改进了徐码判断主副根、Z键使用较多的不便之处。它不分主副根，取一二三末根，不使用Z键，繁简动态重码率都更低。
