-- 名稱: xuma_postpone_full_code.lua
...
local function init(env)
    ...
    env.max_index = config:get_int('xuma_postpone_full_code/lua/max_index')
        or 4
end
...
local function filter(input, env)
    ...
    if not context:get_option("xuma_postpone_full_code") then
